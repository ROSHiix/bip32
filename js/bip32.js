...
var PARTICL_MAINNET_PUBLIC = 0x696e82d1;
var PARTICL_MAINNET_PRIVATE = 0x8f1daeb8;
var PARTICL_TESTNET_PUBLIC = 0xe1427800;
var PARTICL_TESTNET_PRIVATE = 0x04889478;
...
BIP32.prototype.init_from_bytes = function(bytes) {
    ...
    var is_private = 
        (this.version == BITCOIN_MAINNET_PRIVATE  ||
         ...
         this.version == PARTICL_MAINNET_PRIVATE  ||
         this.version == PARTICL_TESTNET_PRIVATE  );
    ...
    var is_public = 
        (this.version == BITCOIN_MAINNET_PUBLIC  ||
         ...
         this.version == PARTICL_MAINNET_PUBLIC  ||
         this.version == PARTICL_TESTNET_PUBLIC  );
...
BIP32.prototype.build_extended_public_key = function() {
    ...
    case LITECOIN_TESTNET_PRIVATE:
        ...
        break;
    case PARTICL_MAINNET_PUBLIC:
    case PARTICL_MAINNET_PRIVATE:
        v = PARTICL_MAINNET_PUBLIC;
        break;
    case PARTICL_TESTNET_PUBLIC:
    case PARTICL_TESTNET_PRIVATE:
        v = PARTICL_TESTNET_PUBLIC;
        break;
     default:
